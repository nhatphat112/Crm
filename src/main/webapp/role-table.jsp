                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        <c:forEach varStatus="loop" var="item" items="${roleList}">
                                        <tr>
                                            <td>${loop.index+1}</td>
                                            <td>${item.getName()}</td>
                                            ...
                                            <td>
                                                <div >
                                                    <form action="<c:url value="/role/mod"/> " method="post">
                                                ...
                                                <div >
                                                        <button roleId="${item.getId()}" class="btn btn-sm btn-delete-role btn-danger" type="submit">Xoá</button>
                                                </div>
                                            </td>
                                            </c:forEach>
                                        </tr>
