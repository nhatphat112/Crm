            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Sửa đổi thành viên</h4>
                    </div>
                </div>
                <%--        announce--%>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material"  enctype="multipart/form-data" action= <c:url value="/user/mod"/> method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="password"  value="${password}" required type="password" placeholder="******" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="country" required class="form-control form-control-line">
