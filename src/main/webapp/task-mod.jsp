        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Sửa đổi công việc</h4>
                </div>
            </div>
            <%--        announce--%>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form method="post" action="<c:url value="/task/mod"/>" class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input name="jobName" required type="text" value="${jobName}" placeholder="Tên công việc"
...
<%--                                return id task current--%>
                            <div class="hidden">
                                <input type="hidden" name="userModifyId" value="${userModifyId}">
                                <input type="hidden" name="jobModifyId" value="${jobModifyId}">
                                <input type="hidden" name="projectModifyId" value="${projectModifyId}">
                                <input type="hidden" name="statusModifyId" value="${statusModifyId}">
                                <input type="hidden" name="methodCustom" value="post">
