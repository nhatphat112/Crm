...
minutesSpecHelper = (interval) ->
  ...
  start: (d) -> new Dates(d.getFullYear(), d.getMonth(), d.getDate(), d.getHours())
...
secondsSpecHelper = (interval) ->
  span: interval * 1000
  start: (d) -> new Dates(d.getFullYear(), d.getMonth(), d.getDate(), d.getHours(), d.getMinutes())
